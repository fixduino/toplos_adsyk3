...
CREATE TABLE `tb_loss` (
  ...
  CONSTRAINT `tb_loss_ibfk_2` FOREIGN KEY (`ref`) REFERENCES `tb_ref` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1;

/*Data for the table `tb_loss` */

insert  into `tb_loss`(`id`,`time`,`ref`,`qty_req`,`tank_tujuan`) values (1,'2017-10-24 09:01:19',8,3500,5),(2,'2017-10-24 09:01:52',9,6700,1),(3,'2017-10-24 09:06:06',3,400,6),(4,'2017-10-24 19:57:43',3,400,6),(5,'2017-10-24 20:09:16',3,400,6),(6,'2017-10-24 20:09:21',3,400,6),(8,'2017-10-24 20:17:27',2,3500,5),(9,'2017-10-24 20:17:40',1,400,4);
...
insert  into `tb_ref`(`id`,`platref`,`qty`,`kode`,`status`) values (1,'AB555CD',13000,'ADS.01',1),(2,'AB1214HN',16000,'ADS.02',1),(3,'AB2222JN',16000,'ADS.03',1),(4,'AB2222JN',16000,'ADS.04',1),(5,'AB2222JN',16000,'ADS.05',1),(6,'AB2222JN',16000,'ADS.06',1),(7,'AB2222JN',16000,'ADS.07',0),(8,'AB2222JN',13000,'ADS.08',0),(9,'AB2222JN',16000,'ADS.09',1),(10,'AB2222JN',16000,'ADS.10',1),(11,'AB2222JN',16000,'ADS.11',1),(12,'AB2222JN',16000,'ADS.12',1),(13,'AB2222JN',16000,'ADS.13',1),(14,'AB2222JN',16000,'ADS.14',1),(15,'AB2222JN',16000,'ADS.15',1),(16,'AB2222JN',16000,'ADS.16',1);
...
insert  into `tb_tank`(`id`,`tank`,`level`,`pa`,`max_level`,`max_pa`,`status`,`sisipan`,`time`,`deadstok`,`patarget`,`targetstat`) values (1,'T1',42,97520,1000,61410,201,500,'2017-10-15 10:37:29',4180,100,0),(2,'T2',127,44666,2000,62090,102,500,'2017-10-24 08:05:39',3920,200,0),(3,'T3',200,58109,200,62230,99,500,'2017-07-30 06:31:48',3320,300,0),(4,'T4',108,58342,200,62930,101,500,'2017-10-14 08:05:56',3600,400,0),(5,'T5',26,103122,200,106200,101,500,'2017-10-14 13:04:49',3530,500,0),(6,'T6',200,1600,200,102350,99,500,'2017-07-30 06:31:48',4550,0,0),(7,'T7',176,78053,200,101930,202,500,'2017-10-14 13:17:51',1920,700,0),(8,'T8',189,97520,200,104050,102,500,'2017-10-13 17:51:53',2180,800,0);
...
insert  into `users`(`id`,`username`,`password`,`type`,`foto`) values (1,'admin','21232f297a57a5a743894a0e4a801fc3','superuser','user.jpg'),(2,'operator','4b583376b2767b923c3e1da60d10de59','piket','user2.png');
